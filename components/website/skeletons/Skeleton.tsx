...
export const HomeMagazineSkeletonGrid = () => (
  <div className="grid grid-cols-12 gap-6 animate-pulse">
    <div className="col-span-12 sm:col-span-6 lg:col-span-7">
      ...
      <div className="flex justify-between items-center">
        <div className="h-6 bg-gray-600 w-24"></div>
        <div className="h-4 bg-gray-600 w-16"></div>
      </div>
    </div>
    <div className="col-span-12 sm:col-span-6 lg:col-span-5 lg:mt-12">
      <div className="mb-8">
        <div className="bg-gray-700 aspect-3/4 mb-4"></div>
        <div className="flex justify-between items-center">
          <div className="h-5 bg-gray-600 w-20"></div>
          <div className="h-4 bg-gray-600 w-14"></div>
        </div>
      </div>
      <div>
        <div className="bg-gray-700 aspect-3/4 mb-4"></div>
...
export const ArticleDetailSkeleton = () => (
  <div className="w-full max-w-7xl mx-auto px-6 lg:px-8 animate-pulse">
    ...
    <div className="relative aspect-video bg-gray-200-lg mb-8"></div>
  ...
  <div className="w-full max-w-7xl mx-auto px-6 lg:px-8 animate-pulse">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
      <div className="lg:col-span-1">
        <div className="bg-gray-200 aspect-3/4-lg"></div>
      </div>
      <div className="lg:col-span-2 space-y-4">
        <div className="h-4 bg-gray-200 w-16"></div>
        <div className="h-10 bg-gray-200 w-full"></div>
        <div className="h-10 bg-gray-200 w-2/3"></div>
        <div className="h-8 bg-gray-200 w-48 mt-8"></div>
