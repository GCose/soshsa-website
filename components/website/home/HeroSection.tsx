...
const HeroSection = () => (
  <section className="relative min-h-screen w-full flex items-center -mt-20">
    ...
    <div className="relative w-full px-6 lg:px-8 py-32">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          <h1 className="text-fluid-6xl font-bold text-white leading-[0.95] tracking-tight mb-8">
        ...
        <motion.div
          className="w-90 h-px bg-white mx-auto mb-12"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
